...
A PHP client for easy use of the [Neurolib](https://www.neurolib.io) recommendation API.
...
```
composer require neurolib/php-api-client
```
or
```
{
    "require": {
        "neurolib/php-api-client": "^3.2.0"
    }
}
```
...
use Neurolib\NeurolibApi\Exceptions as Ex;
