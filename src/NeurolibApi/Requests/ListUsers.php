...
class ListUsers extends Request {
    ...
    /**
     * @var string $filter Boolean-returning [ReQL](https://www.neurolib.io/pages/documentation) expression, which allows you to filter users to be listed. Only the users for which the expression is *true* will be returned.
     */
    protected $filter;
    /**
   ...
   protected $optional;
     ...
     *     - *filter*
     *         - Type: string
     *         - Description: Boolean-returning [ReQL](https://www.neurolib.io/pages/documentation) expression, which allows you to filter users to be listed. Only the users for which the expression is *true* will be returned.
     *     - *count*
     *         - Type: int
