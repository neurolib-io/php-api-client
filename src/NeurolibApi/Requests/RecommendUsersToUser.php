 ...
 */
namespace Neurolib\NeurolibApi\Requests;
use Neurolib\NeurolibApi\Exceptions\UnknownOptionalParameterException;
...
class RecommendUsersToUser extends Request {
    ...
    /**
     * @var string $filter Boolean-returning [ReQL](https://www.neurolib.io/pages/documentation) expression which allows you to filter recommended items based on the values of their attributes.
    ...
    protected $filter;
    /**
     * @var string $booster Number-returning [ReQL](https://www.neurolib.io/pages/documentation) expression which allows you to boost recommendation rate of some items based on the values of their attributes.
   ...
   protected $optional;
     ...
     *     - *filter*
     *         - Type: string
     *         - Description: Boolean-returning [ReQL](https://www.neurolib.io/pages/documentation) expression which allows you to filter recommended items based on the values of their attributes.
     * Filters can be also assigned to a [scenario](https://www.neurolib.io/pages/documentation/scenarios.html) in the [Admin UI](https://admin.neurolib.io).
     *     - *booster*
     *         - Type: string
     *         - Description: Number-returning [ReQL](https://www.neurolib.io/pages/documentation) expression which allows you to boost recommendation rate of some items based on the values of their attributes.
     * Boosters can be also assigned to a [scenario](https://www.neurolib.io/pages/documentation/scenarios.html) in the [Admin UI](https://admin.neurolib.io).
     *     - *logic*
     *         - Type: string|array
