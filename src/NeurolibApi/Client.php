...
namespace Neurolib\NeurolibApi;

use Neurolib\NeurolibApi\Requests\Request;
use Neurolib\NeurolibApi\Exceptions\ResponseException;
use Neurolib\NeurolibApi\Exceptions\ApiTimeoutException;
use Neurolib\NeurolibApi\Util\Util;

/**
 * Client for easy usage of Neurolib recommendation API
*/
class Client{
     ...
     * @ignore
     */
    const BASE_URI = 'api.neurolib.io';
    ...
    /**
     * Create the client
     * @param string $account Name of your account at Neurolib
    ...
    public function __construct($account, $token, $protocol = 'https', $options= array()) {
        ...
        if(getenv('NEUROLIB_API_URI') !== false)
            $this->base_uri = getenv('NEUROLIB_API_URI');
    ...
    protected function getUserAgent() {
        $user_agent = 'neurolib-php-api-client/3.2.0';
    ...
    /**
     * Send a request to the Neurolib API
